...
| 能力 | 说明 |
|---|---|
| 基础诊断 | Word / 文本 PDF · 五大诊断域 · 红黄绿灰分级 · HTML 主交付 + DOCX 存档 · **68 条注册规则** + 7 项交叉核对 + 7 条红色硬伤边界 |
...
主交付为 **HTML 格式**（浏览器直接打开，体验最佳），另附 DOCX 版存档。报告标题为**《论文质量审查报告》**，副标题 **「基于多维规则引擎与证据门禁的提交前质量审查」**，包含 11 个章节：
